...
export const PdfMenu = ({ editor }: EditorMenuProps) => {
  ...
  const handleDownload = useCallback(() => {
    ...
    a.download = editorState.name || "";
    a.click();
  }, [editorState?.src, editorState?.name]);
  ...
  const handleFileChange = useCallback(
    (e: React.ChangeEvent<HTMLInputElement>) => {
      ...
      void uploadPdf(file, editor, pos);
      e.target.value = "";
    },
    [editor],
  );
  ...
  return (
    ...
    >
      <div className={classes.toolbar}>
        ...
        <Tooltip position="top" label={t("Replace pdf")} withinPortal={false}>
          <ActionIcon
